...
from gpjax.precip_gp import VerticalSmoother, VerticalDataset
...
class VariationalPrecipGP(ApproxPrecipGP):
    ...
    def _predict(
        ...
        if component_list is None:
            ...
            Kzt = self.eval_specific_K_xt(z, t, component_list, ref = z)   # [L, M, N]
    ...
    def get_sobol_indicies(self, train_data: Optional[VerticalDataset], component_list: List[List[int]], use_range=False, use_inducing_points=False) -> Num[Array, "L c"]:
