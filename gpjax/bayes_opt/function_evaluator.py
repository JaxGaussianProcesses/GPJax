...
FunctionEvaluator = Callable[[Float[Array, "N D"]], Mapping[str, Dataset]]
"""
...
def build_function_evaluator(
    functions: Mapping[str, Callable[[Float[Array, "N D"]], Float[Array, "N 1"]]]
) -> FunctionEvaluator:
    """
    Takes a dictionary of functions and returns a `FunctionEvaluator` which will
    can be used to evaluate each of the functions at a supplied set of points and
    return a dictionary of datasets storing the evaluated points.
    """
