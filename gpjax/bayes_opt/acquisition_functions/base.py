...
and return the value of the acquisition value at each point in an array of shape $`[N, 1]`$.
"""
...
class AbstractAcquisitionFunctionBuilder(ABC):
    ...
    def build_acquisition_function(
        ...
        """
        Build an `AcqusisitionFunction` from a set of posteriors and datasets.
        """
