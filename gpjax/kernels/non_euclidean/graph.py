"""Matérn graph kernel between vertices of a graph."""
...
class GraphKernel(AbstractKernel):
    ...
    def __post_init__(self):
        """Post-initialisation that ensures a valid Laplacian matrix is provided.
        Further, the eigenvalues and eigenvectors of the Laplacian are computed and
        stored.
        """
