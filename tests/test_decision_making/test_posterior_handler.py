...
from gpjax.decision_making.posterior_optimizer import AdamPosteriorOptimizer
...
def test_get_optimized_posterior_with_no_key_raises_error():
    ...
    posterior_optimizer = AdamPosteriorOptimizer(
        num_iters=100, learning_rate=0.01, objective=training_objective
    )
...
def test_get_posterior_with_optimization_correct_num_datapoints_and_optimized(
    ...
    posterior = posterior_handler.get_posterior(
