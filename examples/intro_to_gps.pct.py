...
# points $\mathbf{y}^{\star}$ through the _posterior predictive distribution_. This is
...
# are _marginalisation_ and _conditioning_. For a joint distribution
...
# the _training data_ and $\mathbf{X}^{\star}$ as the set of _test points_.
